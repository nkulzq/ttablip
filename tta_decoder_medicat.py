...
def main(args, config):
    ...
    train_dataset, val_dataset, test_dataset = create_dataset('caption_medicat', config)  
    ...
    for epoch in range(1):
        ...
        train_stats = train(model_without_ddp, val_loader, optimizer, epoch, device, config)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='./configs/caption_medicat.yaml')
    parser.add_argument('--output_dir', default='output/tta_decoder_medicat')        
